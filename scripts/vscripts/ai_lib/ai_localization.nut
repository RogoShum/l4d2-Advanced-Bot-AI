...
function I18n::init() {
	...
	local tchinese =  {
		...
		botai_fire_protect_on = "AI隊友火焰防護已開啟",
		botai_fire_protect_off = "AI隊友火焰防護已關閉",
		botai_acid_protect_on = "AI隊友酸液防護已開啟",
		botai_acid_protect_off = "AI隊友酸液防護已關閉",
		botai_non_alive_protect_on = "AI隊友非生物（地圖）傷害防護已開啟",
		botai_non_alive_protect_off = "AI隊友非生物（地圖）傷害防護已關閉",
		...
		botai_non_alive_damage = "AI隊友對非生物傷害倍率已設定為："
